...
const Post = ({ post }) => {
  ...
  const commentHandler = async () => {
    try {
      const res = await axios.post(
        `https://mksocialmedia.onrender.com/post/${post._id}/comment`,
        { text },
        {
          headers: {
  ...
  const likeOrDislikeHandler = async () => {
    try {
      ...
      const res = await axios.get(
        `https://mksocialmedia.onrender.com/post/${post._id}/${action}`,
        {
          withCredentials: true,
        }
      );
  ...
  const deletePostHandler = async () => {
    try {
      const res = await axios.delete(
        `https://mksocialmedia.onrender.com/post/delete/${post?._id}`,
        {
          withCredentials: true,
        }
      );
  ...
  const bookmarkHandler = async () => {
    try {
      const res = await axios.get(
        `https://mksocialmedia.onrender.com/post/${post?._id}/bookmark`,
        {
          withCredentials: true,
        }
      );
  ...
  const followOrUnfollowHandler = async () => {
    try {
      const res = await axios.post(
        `https://mksocialmedia.onrender.com/user/followerorunfollow/${post.author._id}`,
        {},
        {
          withCredentials: true,
        }
