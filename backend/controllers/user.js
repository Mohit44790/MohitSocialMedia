...
export const editProfile = async (req, res) => {
  try {
    const userId = req.id;
    const { bio, gender, fullName, username, location } = req.body;
    ...
    if (fullName) user.fullName = fullName; // Update name
...
export const followOrUnfollow = async (req, res) => {
  try {
    ...
    const followings = req.params.id;
...
export const searchUser = async (req, res) => {
  try {
    ...
    // Find users by fullName or username using a case-insensitive search
